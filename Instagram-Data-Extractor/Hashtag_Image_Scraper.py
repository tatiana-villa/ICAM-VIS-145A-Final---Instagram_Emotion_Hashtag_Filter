...
class Insta_Image_Links_Scraper:
    ...
    def main(self):
        ...
        #Change text file to whatever hashtags
        #you'd like to parse - Included files
        # are Happiness_Hashtags.txt,
        #Surprised_Hashtags.txt, & Sadness_Hashtags.txt
        with open('Sadness_Hashtags.txt') as f:
